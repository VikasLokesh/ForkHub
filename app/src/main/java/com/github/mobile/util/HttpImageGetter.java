...
public class HttpImageGetter implements ImageGetter {
    ...
    private Drawable requestRepositoryImage(final String source) throws IOException {
        RepositoryImageSearch repositoryImageSearcher = new RepositoryImageSearch(service);

        List<RepositoryContents> contents = repositoryImageSearcher.requestRepositoryImage(source);
